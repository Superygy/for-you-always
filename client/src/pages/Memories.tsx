...
import pyaarismile from "@/assets/pyaarismile.jpeg";
import mastikhor from "@/assets/mastikhor.jpg";
import coat from "@/assets/coat.jpg";
import  distance  from "@/assets/distance.jpg";
import mypyaaru from "@/assets/mypyaaru.jpg";
import haw from "@/assets/haw.jpg";
import puku from "@/assets/puku.jpg";
import bhukkad from "@/assets/bhukkad.jpg";
import cutu from "@/assets/cutu.jpg";
import Slayed from "@/assets/Slayed.jpg";
...
export default function Memories() {
  ...
  // Placeholder data if empty. Replace these imports with your own local files in src/assets, or use public paths.
  const displayMemories = (memories && memories.length > 0) ? memories : [
    ...
    },
    {
      ...
      url: mastikhor,
      type: "image",
      caption: "Mastikhor moments",
      date: "Pyaari si bacchi",
      rotation: 3
    },
    {
      id: 3,
      url: coat,
      type: "image",
      caption: "Coat kahinke",
      date: "Cutest of all time",
      rotation: -4
    },
    {
      id: 4,
      url: distance,
      type: "image",
      caption: "You're my sunshine even from afar",
      date: "Separated by distance, united by love",
      rotation: 2
    },
    {
      id: 5,
      ...
      type: "image",
      caption: "Surprises",
      date: "I wish I could be there to surprise you in person",
      rotation: 5
    },
    {
      id: 6,
      url: haw,
      type: "image",
      caption: "got completely flattered",
      date: "how could you look so much cute",
      rotation: -3
    },
    {
      id: 7,
    ...
    },
    {
      ...
      type: "image",
      caption: "bas bas..",
      date: "Pighal gaye hai ham aapko dekh ke...",
      rotation: 3
    },
    {
      id: 9,
      url: greenshirt,
      type: "image",
      caption: "beauty in her simplicity",
      date: "bohot jach rahe ho jii",
      rotation: -4
    },
    {
      id: 10,
      url: Slayed,
      type: "image",
      caption: "ham to ghayal he ho gaye aapse",
      date: "mwaahh",
      rotation: 2
    },
    {
      ...
      url: cutu,
      type: "image",
      caption: "I love you so much meri miss special",
      date: "kitni pyaari smile hai hayee..",
      rotation: 5
    },
    {
      id: 12,
      url: bhukkad,
      type: "image",
      caption: "bhukkad but cute",
      date: "kitne pyaare se lagte ho khate hue",
      rotation: -3
    }
  ];
